...
/**
 * Created by deep on 3/10/15.
 */
public class QLearningStochasticEpsilon {
    ...
    public QLearningStochasticEpsilon() {
        Random r = new Random();
        R = new int[13][4];
        visits = new int[13][4];
        sumR = new int[13][4];
    ...
    public void run() {
        ...
        for(int l = 0; l < 200000; l++) {
            ...
            while(state != goalState) {
                ...
                int newdirection = rand.nextDouble() < 0.7 ? direction : actions[rand.nextInt(actions.length)];
    ...
    public static void main(String[] args) {
        ...
        QLearningStochasticEpsilon obj = new QLearningStochasticEpsilon();
